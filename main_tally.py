...
def daybook_xml_request(company, from_date, end_date):
    db_xml="""<ENVELOPE><HEADER>
            ...
            <TDL>
            <TDLMESSAGE>
            <Collection NAME="All_Entries" ISMODIFY="No" ISFIXED="No" ISINITIALIZE="Yes" ISOPTION="No" ISINTERNAL="No">
            <TYPE>Vouchers</TYPE>
...
def get_running_companies(xml_data):
    ...
    '''
    company_list = []
    for names in  xml_data.findAll('COMPANYNAME.LIST'):
        for companies in names.findChildren('COMPANYNAME',recursive=False):
